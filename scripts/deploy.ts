...
async function main() {
  ...
  // Save contract address to file for verification
  writeFileSync('deployment-address.txt', contractAddress);
  console.log('Contract address saved to deployment-address.txt');
